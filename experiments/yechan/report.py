...
import time   # 임시 파일 이름 생성을 위해 추가
import glob   # 파일 삭제를 위해 추가
import requests
import json
...
if __name__ == '__main__':
    print("="*60)
    print("     <<< 테스트 1: 이과 관련 직무 >>>") # 논문 서치 하는지 확인
    print("="*60)
    initial_state_1 = {
        "target_job": "백엔드 개발자",
        "target_company": ["카카오", "네이버"]
    }
    final_state_1 = app.invoke(initial_state_1)
    print("\n--- 최종 결과 ---")
    print(final_state_1.get("final_report"))

if __name__ == '__main__':
    print("="*60)
    print("     <<< 테스트 2: 마케팅 관련 직무 >>>") # 논문 서치 하지 않는지 확인
    print("="*60)
    initial_state_1 = {
        "target_job": "마케팅 관련 직무",
        "target_company": ["CJ 계열사", "삼양식품"]
    }
    final_state_1 = app.invoke(initial_state_1)
    print("\n--- 최종 결과 ---")
    print(final_state_1.get("final_report"))
