...
# config.py에서 키를 가져오도록 수정
from config import (
    NAVER_CLIENT_ID, NAVER_CLIENT_SECRET, NEWS_API_KEY, TAVILY_API_KEY
)
...
def analyze_video_content(video_url: str, question: str) -> str:
    ...
    save_dir = "./temp_audio"
    try:
        # 1. GenericLoader를 사용하여 로더와 파서를 결합합니다.
